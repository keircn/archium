...
void display_version(void) {
  ...
  printf(
      ...
      "                                                  \n"
      "                                                  \n"
      "\033[1;36mArchium v%s\033[0m - \033[1;32mFast & easy package management for Arch Linux\033[0m\n"
      "\033[0mWritten in \033[1mC\033[0m and powered by \033[1mYAY\033[0m, \033[1mParu\033[0m, and \033[1mPacman\033[0m\n"
      "\033[0mPackage Manager: \033[1;36m%s\033[0m (Version: \033[1;36m%s\033[0m)\n"
      "\033[0mBuild Date: \033[1;33m%.3s%s %s\033[0m\n\n"
      "\033[0mThis program is subject to the terms of the \033[1;31mGPL License\033[0m\n"
      "\033[0mArchie originally created by \033[1;36mGurov\033[0m\n"
      "\033[0mArchium forked and maintained by \033[1;36mKeiran\033[0m\n\n"
      "\033[0mGitHub: \033[1;34mhttps://github.com/q4ow/archium\033[0m\n",
