...
void display_version(void) {
  ...
  printf(
      "\033[1;34m"
      "    __     \033[1;36mArchium v%s\033[0m - \033[1;32mFast & easy "
      "package management for Arch Linux\033[0m\n"
      "\033[1;34m .:--.'.   \033[0mWritten in \033[1mC\033[0m and powered "
      "by \033[1mYAY\033[0m, \033[1mParu\033[0m, and \033[1mPacman\033[0m.\n"
      "\033[1;34m/ |   \\ |  \033[0mPackage Manager: \033[1;36m%s\033[0m "
...
void display_help(void) {
  ...
  printf("\033[1;32msize\033[0m        - List installed packages by size\n");
  printf("\033[1;32mrecent\033[0m      - Show recently installed packages\n");
  printf("\033[1;32mexplicit\033[0m    - List explicitly installed packages\n");
  printf("\033[1;32mowns\033[0m        - Find which package owns a file\n");
  printf("\033[1;32mbackup\033[0m      - Backup pacman configuration\n");
